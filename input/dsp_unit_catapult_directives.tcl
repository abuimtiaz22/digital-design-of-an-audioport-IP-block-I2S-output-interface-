...
//  
//  Running on Linux aimtiaz23@lehmus-cn8.oulu.fi:343756 4.18.0-553.44.1.el8_10.x86_64 x86_64 aol
//  
...
solution options set /Cache/UserCacheHome /study/2025/521406S/personal/aimtiaz23/DT3_2025/project/workdir/output/dsp_unit_catapult_cache
...
solution file add ./input/dsp_unit.h -type CHEADER
solution file add ./input/dsp_unit_tb.h -type CHEADER
solution file add ./input/dsp_unit_top.h -type CHEADER
solution file add ./input/dsp_unit.cpp -type C++
solution file add ./input/dsp_unit_tb.cpp -type C++ -exclude true -property PRESERVED_PATH /study/2025/521406S/personal/aimtiaz23/DT3_2025/project/workdir/input/dsp_unit_tb.cpp
solution file add ./input/dsp_unit_top.cpp -type C++ -exclude true -property PRESERVED_PATH /study/2025/521406S/personal/aimtiaz23/DT3_2025/project/workdir/input/dsp_unit_top.cpp
solution file add ./input/dsp_unit_sc_main.cpp -type C++ -exclude true -property PRESERVED_PATH /study/2025/521406S/personal/aimtiaz23/DT3_2025/project/workdir/input/dsp_unit_sc_main.cpp
...
go libraries
directive set /dsp_unit/dsp_proc -MAX_LATENCY 101
directive set /dsp_unit/dsp_proc -AREA_GOAL 83750.000000
directive set /dsp_unit/dsp_proc/SHIFT_LOOP -PIPELINE_INIT_INTERVAL 1
directive set /dsp_unit/dsp_proc/FILTER_LOOP -PIPELINE_INIT_INTERVAL 1
